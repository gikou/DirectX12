...
HRESULT PiplineState::CreatePiplineState(ID3D12Device* dev, ID3D12RootSignature * rootsignature)
{
	...
	HRESULT r = dev->CreateGraphicsPipelineState(&gpsDesc, IID_PPV_ARGS(pipelineState.GetAddressOf()));
	return r;
}
